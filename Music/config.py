...
SUDO_USERS = list(map(int, getenv('SUDO_USERS', '1965132515 1345046161 1605384622').split()))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", ''))
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "RabiscoS_MeuS_77")
ZAID_SUPPORT = getenv("ZAID_SUPPORT", "blazer808_Stay")
